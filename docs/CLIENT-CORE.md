...
| wire codec + schemas | `packages/protocol/src/{codec,schemas,kinds,capabilities,chunking}.ts` | `client_core::wire` | ⏳ |
| `ranges` | `packages/protocol/src/ranges.ts` | `client_core::ranges` | ⏳ |
