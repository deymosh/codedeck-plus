...
| stores (`ui`, `identity`), `presentation` (`displayEntries`, `gsdStages`), `deleteController`, `dmAttachments`, `selectionPersistence`, dm/marmot | `apps/mobile/src/core/**` | `client_core::**` | ⏳ F2a |
